...
assert.ok(html.includes('My name is Swaroop Akkineni.<br>I am an engineer at <a href="https://workos.com/">WorkOS</a> and an avid runner.'));
assert.ok(html.includes('href="https://n26.com/en-eu"'));
assert.ok(html.includes('href="https://www.engineering.pitt.edu/"'));
...
malicious[1].messages[0].paragraphs[0][1].text = '<script>bad</script>';
assert.ok(render(malicious).includes('&lt;script&gt;bad&lt;/script&gt;</a>'));
malicious[1].messages[0].paragraphs[0][1].url = 'javascript:alert(1)';
